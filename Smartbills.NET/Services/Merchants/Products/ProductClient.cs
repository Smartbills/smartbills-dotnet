...
namespace Smartbills.NET.Services.Merchants.Products
{
    ...
    public class ProductClient : Service<SBProduct>, IProductClient
    {
        ...
        {
            return await CreateEntityAsync("/v1/products", request, options, cancellationToken);
        }
        ...
        {
            return await DeleteEntityAsync($"/v1/products/{id}", options, cancellationToken);
        }
        ...
        {
            return await GetEntityByIdAsync($"/v1/products/{id}", options, cancellationToken);
        }
        ...
        {
            return await PaginateEntityAsync($"/v1/products/{id}", request, options, cancellationToken);
        }
        ...
        {
            return await UpdateEntityAsync($"/v1/products/{id}", request, options, cancellationToken);
        }
        ...
        {
            return await CreateEntityAsync<List<ProductCreateRequest>, List<SBProduct>>("/v1/products/batch", request, options, cancellationToken);
        }
        ...
        {
            return await UpdateEntityAsync<List<ProductBatchItemUpdateRequest>, List<SBProduct>>("/v1/products/batch", request, options, cancellationToken);
        }
    }
}
