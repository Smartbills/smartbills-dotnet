...
{
    public interface IMerchantCustomerClient :
    ...
    public class MerchantCustomerClient : Service<SBCustomer>, IMerchantCustomerClient
    {
        public MerchantCustomerClient(ISmartbillsClient client) : base(client)
        {
        }
