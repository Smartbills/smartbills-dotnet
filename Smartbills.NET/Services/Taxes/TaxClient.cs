...
{
    public interface ITaxClient : ICreatable<CreateTaxRequest, SBTax>, IUpdatable<UpdateTaxRequest, SBTax>, IDeletable<SBTax>, IRetrievable<SBTax> { }
    public class TaxClient : Service<SBTax>, ITaxClient
    {
        ...
        public async Task<SBTax> CreateAsync(CreateTaxRequest request, SBRequestOptions options = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<SBTax> UpdateAsync(long id, UpdateTaxRequest request, SBRequestOptions options = null, CancellationToken cancellationToken = default)
        {
